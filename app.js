...
const LEXICON_STOP_WORDS = new Set([
  ...
  "about","after","again","agent","before","being","became","because","begins","between","choosing","compared","could","darker","decision","does","first","from","island","journal","notebook","signs","still","that","their","there","this","through","today","with","without","yesterday",
  // Agent / island names.
