...
const RESOURCE_REGEN_MULTIPLIER = 1.265; // Balance pass: +15% resource regeneration from the previous 1.10 setting.
...
const uiState = { journalHistoryOpen: false };
...
function performAction(island, agent, action, explored){
  ...
  if(action === "socialize"){
    ...
    reward += 1.38 + clueGain * 0.144; // Balance pass: +20% social reward from the original 1.15 + clueGain*0.12 setting.
